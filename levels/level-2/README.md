...
```bash
repo_root="$(pwd)"
bash "$repo_root/levels/level-2/run.sh" test-core
bash "$repo_root/levels/level-2/run.sh" doctor
bash "$repo_root/levels/level-2/run.sh" prepare
bash "$repo_root/levels/level-2/run.sh" test vet build helm-check
